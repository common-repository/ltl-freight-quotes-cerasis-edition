<?php
    ...
    <!--        <a href="#">
                <h2 class="wild_warehouse pakage_notify heading_right"><?php echo $multi_warehouse_package_required; ?></h2>
            </a>-->
                ...
                if (count($warehous_list) > 0) {
                    ...
                    foreach ($warehous_list as $list) {
                        ...
                        <tr class="<?php echo (strlen($tr_disabled_me) > 0 && $count != 0) ? $tr_disabled_me : ""; ?>" id="row_<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>" data-id="<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>">
                            ...
                            <td class="en_wd_warehouse_list_data">
                                <a href="javascript(0)" onclick="return en_wd_edit_warehouse(<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>);"><img src="<?php echo plugins_url(); ?>/ltl-freight-quotes-cerasis-edition/includes/warehouse-dropship/wild/assets/images/edit.png" title="Edit"></a>
                                <a href="javascript(0)" onclick="return en_wd_delete_current_warehouse(<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>);"><img src="<?php echo plugins_url(); ?>/ltl-freight-quotes-cerasis-edition/includes/warehouse-dropship/wild/assets/images/delete.png" title="Delete"></a>
                            </td>
                        </tr>
                        <?php
                        $count++;
    ...
    <!--        <a href="#">
                <h2 class="wild_warehouse pakage_notify heading_right"><?php echo $multi_dropship_package_required; ?></h2>
            </a>-->
                ...
                if (count($dropship_list) > 0) {
                    ...
                    foreach ($dropship_list as $list) {
                        ...
                        <tr class="<?php echo (strlen($tr_disabled_me) > 0 && $count != 0) ? $tr_disabled_me : ""; ?>" id="row_<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>">
                            ...
                            <td class="en_wd_dropship_list_data">
                                <a href="javascript(0)" onclick="return en_wd_edit_dropship(<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>);"><img src="<?php echo plugins_url(); ?>/ltl-freight-quotes-cerasis-edition/includes/warehouse-dropship/wild/assets/images/edit.png" title="Edit"></a>
                                <a href="javascript(0)" onclick="return en_wd_delete_current_dropship(<?php echo ( isset($list->id) ) ? esc_attr($list->id) : ''; ?>);"><img src="<?php echo plugins_url(); ?>/ltl-freight-quotes-cerasis-edition/includes/warehouse-dropship/wild/assets/images/delete.png" title="Delete"></a>
                            </td>
                        </tr>
                        <?php
                        $count++;
