...
$en_web_hook_requests = (isset($get_option) && (!empty($get_option)) && ((is_array($get_option)))) ? json_decode($get_option , TRUE) : array();
$en_web_hook_requests[] = (isset($_GET)) ? $_GET : array();
update_option('cerasis_freights_web_hook_plan_requests' , json_encode($en_web_hook_requests));
